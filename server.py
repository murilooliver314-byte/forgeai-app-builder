...
def clean_video_payload(raw, slug):
    ...
    return {'id':str(raw.get('id') or secrets.token_hex(10))[:40],'product_id':product['id'],'product_name':product['name'],'price':product['price'],'caption':caption,'video':video,'created_at':time.time()}, None
